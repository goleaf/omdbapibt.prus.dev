...
class ImpersonationManager
{
    ...
    public function stop(?User $requester = null): void
    {
        ...
        /** @var User|null $impersonatedForGate */
        $impersonatedForGate = $this->guard()->user();

        if (! $impersonatedForGate instanceof User) {
            abort(403, 'This action is unauthorized.');
        }
        ...
        Gate::forUser($requester)->authorize('endImpersonation', [$impersonatedForGate, $impersonatorForGate]);
