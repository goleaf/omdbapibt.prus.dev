<section class="space-y-6">
    <div>
        <h2 class="text-xl font-semibold text-slate-50">Advanced filters</h2>
        <p class="mt-1 text-sm text-slate-400">Tune your discovery feed with genres, languages, and release years.</p>
    </div>

    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <label class="text-sm font-semibold text-slate-200">Type</label>
            <div class="mt-3 flex gap-3">
                @foreach (['movies' => 'Movies', 'shows' => 'TV Shows'] as $value => $label)
                    <button type="button"
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <label class="text-sm font-semibold text-slate-200" for="genre">Genre</label>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <label class="text-sm font-semibold text-slate-200" for="year">Year</label>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <label class="text-sm font-semibold text-slate-200" for="language">Language</label>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <label class="text-sm font-semibold text-slate-200" for="sort">Sort by</label>
        ...
        <div class="flex items-end justify-between rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
            <div>
                <h3 class="text-sm font-semibold text-slate-200">Results preview</h3>
                <p class="mt-1 text-xs text-slate-400">Filtering {{ $selected['genre'] }} {{ $selected['type'] }} released in {{ $selected['year'] }}.</p>
            </div>
